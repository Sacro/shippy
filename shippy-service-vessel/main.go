...
import (
	...
	pb "github.com/Sacro/shippy/shippy-service-vessel/proto/vessel"
...
func (s *vesselService) FindAvailable(_ context.Context, req *pb.Specification, res *pb.Response) error {
